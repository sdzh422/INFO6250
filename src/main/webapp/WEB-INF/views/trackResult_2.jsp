   ...
   <div id="content-wrap">
      ...
      <main class="row">
            ...
            <div id="main-content" class="twelve columns">
               ...
               <p align="left"> <b>Tracking number:</b>${trackingnum}
               </p>
               ...
               <div id="main-content" class="status">
					...
					<p>A status update is not yet available on your package. 
					It will be available when the shipper provides an update or the package is delivered to us.</p>
               </div>                  
