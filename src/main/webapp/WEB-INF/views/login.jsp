...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; }
        ...
        #username { background: url(resources/images/emil.png) 20px 14px no-repeat; }
...
<body>
    <div class="dowebok">
    <form action="${contextPath}/tracking/LoginAction" method="post">
        <div class="logo"></div>
        <div class="form-item">
        ...
        <div class="form-item"><button id="submit">Log In</button></div>
        </form>
        <div class="reg-bar">
            <a class="reg" href="${contextPath}/tracking/RegistrationAction.htm">Register</a>
            <a class="forget" href="${contextPath}/tracking/passwordResetAction">Forget password</a>
        </div>
    </div>
