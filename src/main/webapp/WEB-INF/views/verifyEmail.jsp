...
<body>
    <div class="dowebok">
    <form action="${contextPath}/tracking/verifyEmailAction" method="post">
    	<div class="logo"></div>
    	<font color="red"><span id="info">${error}</span></font>
        <div class="form-item"> 
            <input id="email" name="secCode" type="text" autocomplete="off" placeholder="Security Code" required>
        </div>
