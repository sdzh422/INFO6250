...
<body>
    <div class="dowebok">
    <form action="${contextPath}/tracking/resetNext" method="post">
    	<div class="logo"></div>
        <div class="form-item"> 
            <input id="password" name="password" type="text" autocomplete="off" placeholder="Password" required>
        </div>
        <div class="form-item"><button id="submit">Finish</button></div>
        </form>
        <div class="reg-bar">
